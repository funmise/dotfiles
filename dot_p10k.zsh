# Generated by Powerlevel10k configuration wizard on 2026-07-16 at 02:25 CST.
...
() {
  ...
  # default: Removes complete older path components, retaining the number specified by SHORTEN_DIR_LENGTH
